                        ...
                        <div class ="card-body">
                            ...
                            <div class ="row">
                                <div class ="col" style="text-align:center">
                                    ...
                                    <asp:Label class = "badge badge-pill badge-success" ID="Label1" runat="server" Text="Active">
                                    </asp:Label>
                                </div>
                            </div>
                            ...
                            <div class ="row">
                                ...
                                <div class ="col-md-6">
                                    ...
                                    <div class = "form-group">
                                        <asp:TextBox CssClass ="form-control" ID="TextBox1" runat="server" placeholder="Type Here...">
                                ...
                                <div class ="col-md-6">
                                    ...
                                    <div class = "form-group">
                                        <asp:TextBox CssClass ="form-control" ID="TextBox3" runat="server" placeholder="Type Here..." TextMode ="Date">
                            ...
                            <div class ="row">
                                ...
                                <div class ="col-md-6">
                                    ...
                                    <div class = "form-group">
                                        <asp:TextBox CssClass ="form-control" ID="TextBox2" runat="server" placeholder="Type Here..." TextMode ="Number">
                                ...
                                <div class ="col-md-6">
                                    ...
                                    <div class = "form-group">
                                        <asp:TextBox CssClass ="form-control" ID="TextBox4" runat="server" placeholder="Type Here..." TextMode ="Email">
                                ...
                                <div class ="col-md-4">
                                    ...
                                    <div class = "form-group">
                                        <asp:DropDownList CssClass ="form-control" ID="DropDownList1" runat="server">
                                            ...
                                            <asp:ListItem Text="Tashkent City" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Tashkent Region" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Andijan" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Bukhara" Value ="select"> </asp:ListItem>
                                            <asp:ListItem Text="Fergana" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Jizzakh" Value ="select" ></asp:ListItem>
                                            <asp:ListItem Text="Karakalpakstan" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Khorezm" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Namangan" Value ="select" ></asp:ListItem>
                                            <asp:ListItem Text="Qashqadaryo" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Samarkand" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Sirdaryo" Value ="select" > </asp:ListItem>
                                            <asp:ListItem Text="Surxondaryo" Value ="select" > </asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div class ="row">
                                ...
                                <div class ="col">
                                    ...
                                    <div class = "form-group">
                                        <asp:TextBox CssClass ="form-control" ID="TextBox5" runat="server" placeholder="Type Here..." TextMode ="MultiLine"  Rows ="2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                             ...
                                             <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Loading..." ReadOnly="true"> </asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class ="col-md-7"> 
                    <div class ="card" >
                        <div class ="card-body">
                            ...
                            <div class ="row">
                                <div class ="col" style="text-align:center">
                                    <img src="images/img/Books_Flat_Icon_Vector.svg.png" width = "95"/>
                                </div>
                            </div>
                            ...
                            <div class ="row">
                                <div class ="col" style="text-align:center">
                                    <h4>Taken Books</h4>
                                    <hr/>
                                    <asp:Label class = "badge badge-pill badge-info" ID="Label2" runat="server" Text="Due Date Info">
                            ...
                            <div class="row">
								<div class="col">
                                    <div class ="table-responsive" style="height: 405px;overflow-y: scroll;overflow-x: hidden;">
								    <asp:GridView class="table table-striped table-bordered " ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="" OnRowDataBound="GridView1_RowDataBound">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script type ="text/javascript">
        ...
        function RunnerMain() {
            ...
            var textDob_c = document.getElementById('<%=TextBox3.ClientID%>').value;
            var textPnum_c = document.getElementById('<%=TextBox2.ClientID%>').value;
            var textEmail_c = document.getElementById('<%=TextBox4.ClientID%>').value;
            var textCname_c = document.getElementById('<%=TextBox6.ClientID%>').value;
            var textPcode_c = document.getElementById('<%=TextBox7.ClientID%>').value;
            var textFaddr_c = document.getElementById('<%=TextBox5.ClientID%>').value;
